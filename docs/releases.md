...
git -C agent-pipeline checkout v0.3.1
...
> **This release refuses an installation that v0.3.0 accepted.** Its number says
> patch; its content does not. Read the migration below before updating.
